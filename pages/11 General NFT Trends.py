...
st.markdown('This part shows the basic NFT trends on **Ethereum** ecosystem. It is intended to provide an overview of the current market for NFTs in Ethereum.')
...
# Set y-axes titles
fig1.update_yaxes(title_text="Daily volume (USD)", secondary_y=False)
fig1.update_yaxes(title_text="Total volume (USD)", secondary_y=True)
...
# Set y-axes titles
fig2.update_yaxes(title_text="Weekly volume (USD)", secondary_y=False)
fig2.update_yaxes(title_text="Total volume (USD)", secondary_y=True)
...
# Set y-axes titles
fig3.update_yaxes(title_text="Monthly volume (USD)", secondary_y=False)
fig3.update_yaxes(title_text="Total volume (USD)", secondary_y=True)
...
# Set y-axes titles
fig1.update_yaxes(title_text="Daily average price (USD)", secondary_y=False)
...
# Set y-axes titles
fig2.update_yaxes(title_text="Weekly average price (USD)", secondary_y=False)
...
# Set y-axes titles
fig3.update_yaxes(title_text="Monthly average price (USD)", secondary_y=False)
