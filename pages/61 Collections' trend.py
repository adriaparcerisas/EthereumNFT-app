...
WITH 
  ...
  SELECT
   ...
   n.nft_address, 
   project_name, 
  n.price_usd,n.seller_address,n.buyer_address,
  platform_name,
  n.tx_hash
...
total_volume_sales "Total volume (USD)",
...
fig2.update_layout(
    title='Violin plot about 24h NFT sales growth % on Ethereum',
    xaxis_tickfont_size=14,
    yaxis_tickfont_size=14,
    legend=dict(
        x=0,
